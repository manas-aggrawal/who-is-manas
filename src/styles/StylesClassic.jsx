// Original theme: white base, vivid orange accent, cartoon polish
// (chunky outlines + hard offset shadows). Extracted verbatim from App.jsx.
...
const StylesClassic = () => (
  <style>{`
    ...
    .card { box-shadow: 0 2px 12px rgba(20,15,10,.05); }
    ...
    .card, .exp-contrib { border: 2px solid var(--toon); box-shadow: var(--toon-sh); border-radius: 16px; }
    .card:hover { transform: translate(-2px, -2px); box-shadow: var(--toon-sh-lg); border-color: var(--toon); background: var(--bg-elev-2); }

    .stat { background: var(--bg-elev-2); border: 2px solid var(--toon); box-shadow: var(--toon-sh); border-radius: 14px; padding: 13px 12px; }

    /* Recommendations read as quote stickers: thick outline, accent spine */
    .rec { border: 2px solid var(--toon); border-left-width: 6px; border-left-color: var(--accent); box-shadow: var(--toon-sh); border-radius: 4px 14px 14px 4px; }
